...
{
    public abstract class BaseConsumerBackgroundService<T> : BackgroundService
    {
        private readonly ILogger<BaseConsumerBackgroundService<T>> _logger;
        private IConsumer<string, string>? _consumer;
        private string[]? _topicsForSubsciption;

        protected BaseConsumerBackgroundService(ILogger<BaseConsumerBackgroundService<T>> logger) => _logger = logger;
